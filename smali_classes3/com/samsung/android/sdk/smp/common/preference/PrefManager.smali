...
.field private static final OPT_IN_POLICY:Ljava/lang/String; = "opt_in_policy"

.field private static final PPMT_DATA_MIGRATION:Ljava/lang/String; = "ppmt_migr"

.field private static final PREFERENCE_VERSION:I = 0x1
...
.field private static final SMP_PREFERENCE_VERSION:Ljava/lang/String; = "smp_preference_version"
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->getPreferenceVersion()I
    ...
    invoke-direct {p0, p1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->migratePreference(I)V
...
.method private migratePreference(I)V
    .locals 3
    ...
    const-string/jumbo v2, "upgrade preference. oldVersion: "
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->getUserBasedOptinEnabled()Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptinPolicy(Lcom/samsung/android/sdk/smp/SmpConstants$OptInPolicy;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v2}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setPreferenceVersion(I)V
...
.method public declared-synchronized getOptinPolicy()Lcom/samsung/android/sdk/smp/SmpConstants$OptInPolicy;
    .locals 2
...
.method public declared-synchronized getPreferenceVersion()I
    .locals 2

    monitor-enter p0

    :try_start_0
    const-string/jumbo v0, "smp_preference_version"
...
.method public declared-synchronized setOptinPolicy(Lcom/samsung/android/sdk/smp/SmpConstants$OptInPolicy;)V
    .locals 1
...
.method public declared-synchronized setPreferenceVersion(I)V
    .locals 1
