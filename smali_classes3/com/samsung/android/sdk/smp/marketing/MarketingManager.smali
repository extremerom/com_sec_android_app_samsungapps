...
.method private static addCustomContentFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;)V
    .locals 2

    if-eqz p2, :cond_1

    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;->isSuccess()Z
    ...
    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;->getError()Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult$Error;
    ...
    :cond_0
    sget-object v0, Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;->CUSTOM_CONTENT_REQUEST_FAILED:Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;

    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;->getErrorMessage()Ljava/lang/String;

    move-result-object p2

    invoke-static {p0, p1, v0, p2}, Lcom/samsung/android/sdk/smp/marketing/FeedbackManager;->addFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
...
.method private static adjustMarketingDisplayTimeByTimeBase(Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->ttl:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;

    iget-object v1, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;
    ...
    invoke-static {v1, v2}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil;->adjustLocalTimeToUtc0(J)J
    ...
    iput-object v1, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;

    iget-object p0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->ttl:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;
    ...
    iput-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->end:Ljava/lang/Object;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->displayTime:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;

    iget-object v1, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;

    check-cast v1, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;

    invoke-static {v1}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil;->adjustUtc0ToLocalTime(Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;)Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;

    move-result-object v1

    iput-object v1, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;

    iget-object p0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->displayTime:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;
...
.method private static checkFcmRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 7
    ...
    iget-object p2, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->ttl:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;

    iget-object p2, p2, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;
    ...
    iget-object p2, p2, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->end:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p2, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->displayTime:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;

    iget-object v0, p2, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;
    ...
    check-cast v2, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;

    iget-object p0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->doNotDisturbTime:Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;

    iget-object p2, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->start:Ljava/lang/Object;

    move-object v3, p2

    check-cast v3, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;

    iget-object p0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$PairTime;->end:Ljava/lang/Object;

    move-object v4, p0

    check-cast v4, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;
    ...
    const-string v1, "real time marketing : "
    ...
    invoke-static {p2, p1, v0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static deleteIncompletedMarketings(Landroid/content/Context;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getAllIncompletedMarketingList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-static {p0, v2}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->cancelAllMarketingAlarms(Landroid/content/Context;Ljava/lang/String;)V

    sget-object v3, Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;->USER_INFO_CHANGED:Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;

    invoke-static {p0, v2, v3, p1}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    const-string v5, "deleteIncompletedMarketings. mid: "
    ...
    invoke-static {v3, v4}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "deleteIncompletedMarketings. error while parsing "
...
.method private static dispatchOnServiceCustomContentRequest(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 3
    ...
    const-string v2, "request_custom_content"
    ...
    invoke-direct {p2, p3, v0, p1}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private static dispatchOnServiceDeliver(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;Ljava/lang/String;II)V
    .locals 2

    iget-object v0, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    sget-object v1, Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;->DELIVER:Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;

    invoke-static {p0, p4}, Lcom/samsung/android/sdk/smp/data/DebugDataManager;->generateDeliverFeedbackDetail(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p4

    invoke-static {p0, v0, v1, p4}, Lcom/samsung/android/sdk/smp/marketing/FeedbackManager;->addFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    iget-object v1, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->msgType:Ljava/lang/String;
    ...
    invoke-direct {p2, p3, p4, p1}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private static finishRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/samsung/android/sdk/smp/common/sharedvariable/SharedMemoryVariableManager;->isRunningRealtimeMidInFcmService(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_0

    const-string p0, "real time marketing already finished"

    invoke-static {v0, p1, p0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static getCustomContent(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;
    .locals 3
    ...
    iget-object v1, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->customContent:Ljava/lang/String;
    ...
    new-instance p0, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;

    sget-object p1, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult$Error;->INVALID:Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult$Error;

    invoke-direct {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;-><init>(Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult$Error;)V
    ...
    new-instance v1, Lcom/samsung/android/sdk/smp/marketing/customcontent/entity/NudgeEntity;

    iget-object v2, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    iget-object p1, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->userdata:Ljava/lang/String;

    invoke-direct {v1, v2, v0, p1}, Lcom/samsung/android/sdk/smp/marketing/customcontent/entity/NudgeEntity;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p0, v1}, Lcom/samsung/android/sdk/smp/marketing/CustomContentManager;->requestCustomContent(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/customcontent/entity/CustomContentEntity;)Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;
...
.method private static getDisplayedMarketings(Landroid/content/Context;)Ljava/util/ArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v0, "getDisplayedMarketings. dbHandler null"
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingList(Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Ljava/util/ArrayList;
    ...
    const-string v1, "getDisplayedMarketings. fail to get marketings"
...
.method public static getMarketing(Landroid/content/Context;Ljava/lang/String;)Lcom/samsung/android/sdk/smp/marketing/Marketing;
    ...
    .annotation system Ldalvik/annotation/Throws;
        value = {
            ...
            Lcom/samsung/android/sdk/smp/common/exception/InternalException$DisplayErrorDueToDoNotDisturbTimeException;
        }
    .end annotation
...
.method public static getUndeletableDisplayedNotifications(Landroid/content/Context;)Ljava/util/HashMap;
    .locals 5
    ...
    invoke-static {p0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->getDisplayedMarketings(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->isUndeletable()Z
    ...
    invoke-virtual {v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->getMid()Ljava/lang/String;
...
.method public static handleBootOrUpdateEvent(Landroid/content/Context;Z)V
    ...
    invoke-static {p0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->getUndeletableDisplayedNotifications(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->redisplayMarketing(Landroid/content/Context;Ljava/util/ArrayList;)V

    invoke-static {p0, v0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->handleDisplayedMarketingsWhenBootOrUpdate(Landroid/content/Context;Ljava/util/HashMap;Z)V
...
.method private static handleCustomContent(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Ljava/lang/String;
    .locals 3

    invoke-static {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->getCustomContent(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;

    move-result-object v0

    invoke-virtual {v0}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;->isSuccess()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;->getMessage()Ljava/lang/String;
    ...
    const-string v2, "fail to request custom content"

    invoke-static {v1, v2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    invoke-static {p0, p1, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->addCustomContentFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/customcontent/CustomContentResult;)V
...
.method private static handleDisplayedMarketingsWhenBootOrUpdate(Landroid/content/Context;Ljava/util/HashMap;Z)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static handleFcmMessage(Landroid/content/Context;Ljava/lang/String;I)V
    .locals 5

    invoke-static {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->handleMessageData(Landroid/content/Context;Ljava/lang/String;)Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;
    ...
    invoke-static {p0, v0, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->checkFcmRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->isCustomContent(Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Z

    move-result v3

    if-eqz v3, :cond_4

    invoke-static {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->handleCustomContent(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    invoke-static {p0, v4, v3}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->updateMarketingUserdataToDB(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v2, v3}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->checkFcmRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    iget-object v2, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    invoke-static {p0, v2, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->updateFcmRealtimeMarketingStatus(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    :cond_4
    :goto_0
    invoke-static {p0, p1, v2, v1, p2}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->dispatchOnServiceDeliver(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;Ljava/lang/String;II)V
    :try_end_1
...
.method private static handleMessageData(Landroid/content/Context;Ljava/lang/String;)Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;
    .locals 1
    ...
    const-string v0, "fail to handle message. invalid data"
...
.method public static handleSppCustomContentMessage(Landroid/content/Context;Ljava/lang/String;I)V
    .locals 3
    ...
    :cond_0
    iget-object v0, p1, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->userdata:Ljava/lang/String;
    ...
    invoke-static {p0, v2, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->updateMarketingUserdataToDB(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v0, p2, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->dispatchOnServiceDeliver(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;Ljava/lang/String;II)V

    return-void
.end method

.method public static handleSppMessage(Landroid/content/Context;Ljava/lang/String;)V
    .locals 4
    ...
    :cond_0
    :try_start_0
    iget-object v1, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    iget-object v2, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->msgType:Ljava/lang/String;

    iget-object v3, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->userdata:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->userdata:Ljava/lang/String;

    invoke-static {v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->isCustomContent(Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v2, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    invoke-static {p0, v2, p1, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->dispatchOnServiceCustomContentRequest(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p0, v0, v2, v1, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->dispatchOnServiceDeliver(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;Ljava/lang/String;II)V
    :try_end_0
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$WrongMarketingDataException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    iget-object v0, v0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->mid:Ljava/lang/String;

    invoke-static {p1, p0, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->handleMarketingExceptions(Ljava/lang/Exception;Landroid/content/Context;Ljava/lang/String;)V
...
.method private static isCustomContent(Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;)Z
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->customContent:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$AppData;->customContent:Ljava/lang/String;
...
.method private static startRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string p0, "real time marketing already running"
    ...
    :cond_0
    invoke-virtual {v1, p1}, Lcom/samsung/android/sdk/smp/common/sharedvariable/SharedMemoryVariableManager;->addRunningRealtimeMidInFcmService(Ljava/lang/String;)V
...
.method private static updateFcmRealtimeMarketingStatus(Landroid/content/Context;Ljava/lang/String;Z)V
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->startRealtimeMarketing(Landroid/content/Context;Ljava/lang/String;)V
...
.method private static updateMarketingUserdataToDB(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 2
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingUserData(Ljava/lang/String;Ljava/lang/String;)Z
