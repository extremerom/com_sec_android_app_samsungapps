...
.field private static final PARAM_REDIRECT_MCC:Ljava/lang/String; = "mcc"
...
# instance fields
.field final synthetic this$0:Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;
...
.method private appendMccToRedirectionUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    .locals 1

    invoke-static {p1}, Lcom/samsung/android/sdk/smp/common/util/DeviceInfoUtil;->getSimMcc(Landroid/content/Context;)Ljava/lang/String;
...
.method private getRedirectionUri(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/samsung/android/sdk/smp/common/exception/InternalException$WrongMarketingDataException;
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->this$0:Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;

    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/MarketingLink;->getUrl()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->isSmpProviderUri(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2, p3, p1}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->replaceUriQueryParameter(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    invoke-direct {p0, p1, p5}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendWebIdToRedirectionUri(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p3, p5}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendWebIdToRedirectionUri(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p3

    invoke-direct {p0, p4, p3, p2}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendReferrerToRedirectionUri(Ljava/lang/String;Landroid/net/Uri;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;)Landroid/net/Uri;

    move-result-object p2

    invoke-direct {p0, p1, p4, p2, p6}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendSmpPKToRedirectionUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Z)Landroid/net/Uri;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendMccToRedirectionUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public getLandingIntentForRedirectionUrl(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Landroid/content/Intent;Z)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->isCustomDeeplink(Ljava/lang/String;)Z
    ...
    invoke-direct/range {v2 .. v8}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->getRedirectionUri(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
