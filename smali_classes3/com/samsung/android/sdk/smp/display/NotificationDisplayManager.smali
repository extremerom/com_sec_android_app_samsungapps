...
.method private getCustomContentViewNotification(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)Landroid/app/Notification;
    ...
    invoke-static {p1, p2}, Lcom/samsung/android/sdk/smp/display/c;->a(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;

    :cond_0
    if-eqz p3, :cond_1

    invoke-static {p1, p3}, Lcom/samsung/android/sdk/smp/display/d;->a(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
...
.method private getNotificationBuilder(Landroid/content/Context;Landroid/os/Bundle;)Landroid/app/Notification$Builder;
    ...
    invoke-static {p1, p2}, Lcom/samsung/android/iap/activity/a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/app/Notification$Builder;
...
.method private getNotificationButtonClickIntentUnderS(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;Z)Landroid/content/Intent;
    ...
    const-string p1, "feedback_event"
...
.method private isUndeletableNotification(Landroid/content/Context;Landroid/os/Bundle;)Z
    .locals 2
...
.method private setNotificationConfigs(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/Notification;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->isUndeletableNotification(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    iput v1, p3, Landroid/app/Notification;->color:I
    ...
    invoke-static {p3}, Lcom/samsung/android/sdk/smp/display/e;->a(Landroid/app/Notification;)Ljava/lang/String;
    ...
    :cond_2
    iput v0, p3, Landroid/app/Notification;->priority:I
    ...
    iget p2, p3, Landroid/app/Notification;->defaults:I

    or-int/2addr p2, v0

    iput p2, p3, Landroid/app/Notification;->defaults:I
    ...
    iget p1, p3, Landroid/app/Notification;->defaults:I
...
.method public display(Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;)V
    ...
    invoke-direct {p0, p1, p2, v2}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->setNotificationConfigs(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/Notification;)V
    ...
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$ImageDecodingException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/lang/OutOfMemoryError; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$AppIconNotfoundException; {:try_start_0 .. :try_end_0} :catch_5
