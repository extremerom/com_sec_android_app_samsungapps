...
.method private createDefaultNotificationChannel(Landroid/content/Context;ILjava/lang/String;IZ)V
    ...
    invoke-static {p3, p4, v1}, Landroidx/browser/trusted/g;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p4

    const/4 v1, 0x0

    invoke-static {p4, v1, v1}, Lcom/samsung/android/game/cloudgame/sdk/utility/k;->a(Landroid/app/NotificationChannel;Landroid/net/Uri;Landroid/media/AudioAttributes;)V

    invoke-static {p4, p5}, Lcom/samsung/android/sdk/smp/display/a;->a(Landroid/app/NotificationChannel;Z)V

    const/4 p5, 0x0

    invoke-static {p4, p5}, Lcom/samsung/android/sdk/smp/display/b;->a(Landroid/app/NotificationChannel;Z)V

    invoke-static {v0, p4}, Landroidx/browser/trusted/d;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
...
.method public getNotificationChannelId(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v1, v0}, Landroidx/browser/trusted/b;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
