...
.method private static canUploadClientsForInit(JJJ)Z
    .locals 0
    ...
    sget-wide p2, Lcom/samsung/android/sdk/smp/common/constants/Constants;->UPLOAD_CLIENTS_FOR_INIT_COOLING_MILLIS:J
...
.method private static checkOptInFailCase(Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    const-string p1, "Guid is not set. Should request after Smp.setGuid is called"
...
.method private static removeDefaultChannelAndReplace(Landroid/content/Context;Lcom/samsung/android/sdk/smp/SmpConfiguration$ChannelInfo$Type;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p2}, Lcom/samsung/android/game/cloudgame/sdk/utility/f;->a(Landroid/app/NotificationManager;Ljava/lang/String;)V
...
.method public static saSignInOrOut(Landroid/content/Context;)V
    .locals 1

    const-string v0, "sa_sign_in_or_out"

    invoke-static {p0, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->deleteIncompletedMarketings(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static setGuid(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptIn(Z)V

    const-wide/16 v1, 0x0

    invoke-virtual {v0, v1, v2}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptInTime(J)V

    :cond_1
    const-string/jumbo p1, "uid_changed"

    invoke-static {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->deleteIncompletedMarketings(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static setNotifChannel(Landroid/content/Context;Ljava/util/Map;)V
    ...
    invoke-static {v0, v3}, Landroidx/browser/trusted/b;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
...
.method public static declared-synchronized setOptIn(Landroid/content/Context;ZJI)Lcom/samsung/android/sdk/smp/SmpResult;
    .locals 5
    ...
    invoke-virtual {v3, p0}, Lcom/samsung/android/sdk/smp/common/preference/InitOptionsHolder;->isUserBasedOptIn(Landroid/content/Context;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-static {p0, p1, p4}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->setOptInForUserBased(Landroid/content/Context;ZI)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->setOptInForDeviceOrIntegrateBased(Landroid/content/Context;ZJ)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    const-string v4, "opt-in success. optin_time : "
    ...
    invoke-static {v2, p3}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->hi(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "opt-out success. optin_time : "
    ...
    const-string p1, "opt_in_changed"
    ...
    invoke-static {v2, p0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->he(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static setOptInForDeviceOrIntegrateBased(Landroid/content/Context;ZJ)Lcom/samsung/android/sdk/smp/SmpResult;
    .locals 1
    ...
    invoke-virtual {p0, p2, p3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptInTime(J)V
...
.method private static setOptInForUserBased(Landroid/content/Context;ZI)Lcom/samsung/android/sdk/smp/SmpResult;
    .locals 3
    ...
    invoke-static {v1, v0}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->checkOptInFailCase(Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    :cond_0
    invoke-static {p0, v1, v0, p1, p2}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->requestSetUserOptIn(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ZI)Lcom/samsung/android/sdk/smp/SmpResult;
...
.method public static setSmpInitResultListener(Lcom/samsung/android/sdk/smp/SmpListeners$SmpInitResultListener;)V
    ...
    const-string v1, "set init result listener"
...
.method public static setSmpPushResultListener(Lcom/samsung/android/sdk/smp/SmpListeners$SmpPushResultListener;)V
    ...
    const-string v1, "set push result listener"
...
.method private static uploadClientsForInit(Landroid/content/Context;)V
    ...
    invoke-static {p0, v2}, Lcom/samsung/android/sdk/smp/data/DataManager;->triggerUploadClientsNow(Landroid/content/Context;Z)V
    ...
    invoke-static/range {v3 .. v8}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->canUploadClientsForInit(JJJ)Z
    ...
    invoke-virtual {v0, v13, v14}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setLastUploadTryTime(J)V
    ...
    sget-wide v0, Lcom/samsung/android/sdk/smp/common/constants/Constants;->UPLOAD_CLIENTS_FOR_INIT_COOLING_MILLIS:J
    ...
    const-string/jumbo v4, "until upload period : "
