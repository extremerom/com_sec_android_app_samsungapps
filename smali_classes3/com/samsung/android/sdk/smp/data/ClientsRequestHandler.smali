...
.method private buildBasicData()Lorg/json/JSONObject;
    ...
    invoke-static {}, Lcom/samsung/android/sdk/smp/common/util/DeviceInfoUtil;->getOneUIVersion()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/smp/data/BasicData;->setOneUIV(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/samsung/android/sdk/smp/common/util/DeviceInfoUtil;->isProductShip()Z

    move-result v2

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/smp/data/BasicData;->setIsProductShip(Z)V
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->getOptinPolicy()Lcom/samsung/android/sdk/smp/SmpConstants$OptInPolicy;
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/smp/data/BasicData;->setIntegratedOptin(Z)V
...
.method private notifyInitAndUpdateAppFilterForSps(Lcom/samsung/android/sdk/smp/data/ClientsRequest;)Z
    ...
    :goto_1
    :try_start_2
    sget-object v4, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->TAG:Ljava/lang/String;
    ...
    invoke-static {v4, p1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->he(Ljava/lang/String;Ljava/lang/String;)V
...
.method public handleResponse(Ljava/lang/String;)V
    ...
    const-string v2, "ackperiod"

    const-string/jumbo v3, "version"

    const-string v4, "activeperiod"

    const-string/jumbo v5, "uploadperiod"
    ...
    invoke-virtual {v7, v6}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setActivityTrackingEnabled(Z)V
    ...
    invoke-virtual {v7, v5, v6}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setUploadPeriod(J)V
    ...
    invoke-virtual {v6, v4, v5}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setActivePeriod(J)V
    ...
    invoke-virtual {v4, v3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setConfigVersion(I)V
    ...
    invoke-virtual {v4, v2, v3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setAckPeriod(J)V
    ...
    invoke-virtual {v2, v1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setBaseUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setContentsTypePolicy(Ljava/lang/String;)V
