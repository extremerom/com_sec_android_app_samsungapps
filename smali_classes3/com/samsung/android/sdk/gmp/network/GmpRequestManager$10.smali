...
# direct methods
.method public constructor <init>(Lcom/samsung/android/sdk/gmp/network/GmpRequestManager;Landroid/content/Context;ILjava/lang/String;Lcom/android/volley/Response$Listener;Lcom/android/volley/Response$ErrorListener;Ljava/lang/String;Lorg/json/JSONArray;)V
    .locals 6
...
.method public getBody()[B
    ...
    :try_start_0
    const-string/jumbo v4, "x-gmp-mid"
    ...
    :try_start_1
    const-string/jumbo v4, "x-gmp-mcc"
    ...
    :try_start_2
    const-string/jumbo v4, "x-gmp-mnc"
    ...
    :try_start_3
    const-string/jumbo v4, "x-gmp-cc2"
    ...
    :try_start_4
    const-string/jumbo v4, "x-gmp-sales-cd"
    ...
    :try_start_6
    const-string/jumbo v4, "x-gmp-prod"
    ...
    :try_start_7
    const-string/jumbo v4, "x-gmp-push"
    ...
    :try_start_9
    const-string/jumbo v4, "x-gmp-dmid"
    ...
    :try_start_a
    const-string/jumbo v4, "x-gmp-ver"
    ...
    :try_start_b
    const-string/jumbo v4, "x-gmp-model-id"
    ...
    :try_start_c
    const-string/jumbo v4, "x-gmp-lang"
    ...
    :try_start_d
    const-string/jumbo v4, "x-gmp-mnfctr"
    ...
    :try_start_e
    const-string/jumbo v4, "x-gmp-os"
    ...
    :try_start_f
    const-string/jumbo v4, "x-gmp-ver-sdk"
    ...
    :try_start_10
    const-string/jumbo v4, "x-gmp-encmail"
    ...
    :try_start_11
    const-string/jumbo v4, "x-gmp-phyaddress"
    ...
    :try_start_12
    const-string/jumbo v4, "x-gmp-namecheck"
    ...
    :try_start_13
    const-string/jumbo v4, "x-gmp-encsn"
    ...
    :try_start_14
    const-string/jumbo v4, "x-gmp-encage"
    ...
    :try_start_15
    const-string/jumbo v4, "x-gmp-event-auth"
    ...
    :try_start_16
    const-string/jumbo v4, "x-gmp-alarmconsent"
    ...
    :try_start_17
    iget-object v3, p0, Lcom/samsung/android/sdk/gmp/network/GmpRequestManager$10;->val$jsonArray:Lorg/json/JSONArray;
    ...
    const-string v4, "Gmp requestSendEvent JSONException"
...
.method public getHeaders()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/samsung/android/sdk/gmp/network/GmpRequestManager$10;->val$actionType:Ljava/lang/String;
