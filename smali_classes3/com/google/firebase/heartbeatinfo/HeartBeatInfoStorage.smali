...
.method private declared-synchronized getFormattedDate(J)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/firebase/heartbeatinfo/e;->a(Ljava/util/Date;)Ljava/time/Instant;

    move-result-object p1

    invoke-static {}, Lcom/google/firebase/heartbeatinfo/f;->a()Ljava/time/ZoneOffset;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/google/firebase/heartbeatinfo/g;->a(Ljava/time/Instant;Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;

    move-result-object p1

    invoke-static {p1}, Lcom/google/firebase/heartbeatinfo/h;->a(Ljava/time/OffsetDateTime;)Ljava/time/LocalDateTime;

    move-result-object p1

    invoke-static {}, Lcom/google/firebase/heartbeatinfo/i;->a()Ljava/time/format/DateTimeFormatter;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/google/firebase/heartbeatinfo/j;->a(Ljava/time/LocalDateTime;Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
