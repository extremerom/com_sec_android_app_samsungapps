...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->f:Landroid/content/ContentResolver;
...
.method public close()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->g:Landroid/net/Uri;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->i:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->i:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->h:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->h:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->k:Z

    if-eqz v0, :cond_2

    iput-boolean v1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->k:Z
    ...
    :try_start_4
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->h:Landroid/content/res/AssetFileDescriptor;
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->g:Landroid/net/Uri;
...
.method public open(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->f:Landroid/content/ContentResolver;
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->h:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-wide v2, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
    ...
    iput-wide v6, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
    ...
    iput-wide v1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
    ...
    iput-boolean v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->k:Z

    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c;->d(Lcom/google/android/exoplayer2/upstream/DataSpec;)V

    iget-wide v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
...
.method public read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->i:Ljava/io/FileInputStream;
    ...
    iget-wide p1, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
    ...
    :cond_4
    iget-wide p2, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
    ...
    iput-wide p2, p0, Lcom/google/android/exoplayer2/upstream/ContentDataSource;->j:J
