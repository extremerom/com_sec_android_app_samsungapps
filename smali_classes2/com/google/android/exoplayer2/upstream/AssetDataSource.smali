...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->f:Landroid/content/res/AssetManager;
...
.method public close()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->g:Landroid/net/Uri;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->h:Ljava/io/InputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->h:Ljava/io/InputStream;

    iget-boolean v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->j:Z

    if-eqz v0, :cond_1

    iput-boolean v1, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->j:Z
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->g:Landroid/net/Uri;
...
.method public open(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->f:Landroid/content/res/AssetManager;
    ...
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J

    goto :goto_1

    :cond_2
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->h:Ljava/io/InputStream;
    ...
    iput-wide v3, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :cond_3
    :goto_1
    iput-boolean v2, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->j:Z

    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c;->d(Lcom/google/android/exoplayer2/upstream/DataSpec;)V

    iget-wide v0, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J
...
.method public read([BII)I
    ...
    iget-wide p1, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J
    ...
    :cond_4
    iget-wide p2, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J
    ...
    iput-wide p2, p0, Lcom/google/android/exoplayer2/upstream/AssetDataSource;->i:J
