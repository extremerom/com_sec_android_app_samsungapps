...
.field public f:Lcom/google/android/exoplayer2/audio/t;
...
.method public d(Z)J
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->n()V
    ...
    iget-object v5, v0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->f:Lcom/google/android/exoplayer2/audio/t;

    invoke-static {v5}, Lcom/google/android/exoplayer2/util/a;->g(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/google/android/exoplayer2/audio/t;

    invoke-virtual {v5}, Lcom/google/android/exoplayer2/audio/t;->d()Z
    ...
    invoke-virtual {v5}, Lcom/google/android/exoplayer2/audio/t;->c()J
    ...
    invoke-static {v9, v10, v5}, Lcom/google/android/exoplayer2/util/l0;->f0(JF)J
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->g()J
    ...
    invoke-static {v3, v4, v5}, Lcom/google/android/exoplayer2/util/l0;->m0(JF)J
...
.method public e(J)J
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->b(J)J
...
.method public final m(JJ)V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->f:Lcom/google/android/exoplayer2/audio/t;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/exoplayer2/audio/t;->f(J)Z
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/audio/t;->c()J

    move-result-wide v5

    invoke-virtual {v0}, Lcom/google/android/exoplayer2/audio/t;->b()J
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/audio/t;->g()V
    ...
    :cond_2
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/audio/t;->a()V
...
.method public final n()V
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->g()J
    ...
    :cond_3
    invoke-virtual {p0, v4, v5, v0, v1}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->m(JJ)V

    invoke-virtual {p0, v4, v5}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->o(J)V
...
.method public final o(J)V
    ...
    iget-wide v4, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->i:J
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->a:Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker$Listener;

    invoke-interface {v0, v2, v3}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker$Listener;->onInvalidLatency(J)V

    iput-wide v4, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->o:J
    :try_end_0
    ...
    :catch_0
    iput-object v1, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->n:Ljava/lang/reflect/Method;
...
.method public q()Z
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->s()V
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/audio/t;->h()V
...
.method public r()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->f:Lcom/google/android/exoplayer2/audio/t;
...
.method public t(Landroid/media/AudioTrack;ZIII)V
    ...
    new-instance v0, Lcom/google/android/exoplayer2/audio/t;

    invoke-direct {v0, p1}, Lcom/google/android/exoplayer2/audio/t;-><init>(Landroid/media/AudioTrack;)V
    ...
    invoke-static {p3}, Lcom/google/android/exoplayer2/util/l0;->C0(I)Z
...
.method public u(F)V
    ...
    iget-object p1, p0, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker;->f:Lcom/google/android/exoplayer2/audio/t;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lcom/google/android/exoplayer2/audio/t;->h()V
