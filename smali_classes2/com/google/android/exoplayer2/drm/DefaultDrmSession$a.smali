...
.method public final a(Landroid/os/Message;Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;)Z
    ...
    iget-object v7, v0, Lcom/google/android/exoplayer2/drm/DefaultDrmSession$a;->a:Lcom/google/android/exoplayer2/drm/DefaultDrmSession;

    invoke-static {v7}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->d(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/LoadErrorHandlingPolicy;
    ...
    invoke-direct/range {v9 .. v20}, Lcom/google/android/exoplayer2/source/t;-><init>(JLcom/google/android/exoplayer2/upstream/DataSpec;Landroid/net/Uri;Ljava/util/Map;JJJ)V

    new-instance v6, Lcom/google/android/exoplayer2/source/w;

    invoke-direct {v6, v8}, Lcom/google/android/exoplayer2/source/w;-><init>(I)V
    ...
    invoke-direct {v8, v4, v6, v2, v3}, Lcom/google/android/exoplayer2/upstream/LoadErrorHandlingPolicy$a;-><init>(Lcom/google/android/exoplayer2/source/t;Lcom/google/android/exoplayer2/source/w;Ljava/io/IOException;I)V

    invoke-interface {v7, v8}, Lcom/google/android/exoplayer2/upstream/LoadErrorHandlingPolicy;->getRetryDelayMsFor(Lcom/google/android/exoplayer2/upstream/LoadErrorHandlingPolicy$a;)J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v3, Lcom/google/android/exoplayer2/drm/ExoMediaDrm$a;

    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/MediaDrmCallback;->executeKeyRequest(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/ExoMediaDrm$a;)[B
    ...
    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/MediaDrmCallback;->executeProvisionRequest(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/ExoMediaDrm$c;)[B
    ...
    invoke-static {v2, v3, v1}, Lcom/google/android/exoplayer2/util/n;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->d(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/LoadErrorHandlingPolicy;
    ...
    iget-object v2, v2, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->m:Lcom/google/android/exoplayer2/drm/DefaultDrmSession$c;
