...
.method private createRawCall()Lokhttp3/Call;
    ...
    invoke-virtual {v1, v2}, Lretrofit2/RequestFactory;->create([Ljava/lang/Object;)Lokhttp3/k0;

    move-result-object v1

    invoke-interface {v0, v1}, Lokhttp3/Call$Factory;->newCall(Lokhttp3/k0;)Lokhttp3/Call;
...
.method public execute()Lretrofit2/Response;
    ...
    :cond_0
    invoke-interface {v0}, Lokhttp3/Call;->execute()Lokhttp3/m0;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lokhttp3/m0;)Lretrofit2/Response;
...
.method public parseResponse(Lokhttp3/m0;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lokhttp3/n0;)V
    ...
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lokhttp3/m0;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lokhttp3/n0;)Lokhttp3/n0;

    move-result-object v1

    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lokhttp3/n0;Lokhttp3/m0;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lokhttp3/k0;
    .locals 3
    ...
    invoke-interface {v0}, Lokhttp3/Call;->request()Lokhttp3/k0;
...
.method public declared-synchronized timeout()Lokio/s0;
    .locals 3
    ...
    invoke-interface {v0}, Lokhttp3/Call;->timeout()Lokio/s0;
