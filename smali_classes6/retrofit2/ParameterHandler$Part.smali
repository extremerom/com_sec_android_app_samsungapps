...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILokhttp3/w;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lretrofit2/ParameterHandler$Part;->headers:Lokhttp3/w;
...
.method public apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lretrofit2/ParameterHandler$Part;->headers:Lokhttp3/w;

    invoke-virtual {p1, p2, v0}, Lretrofit2/RequestBuilder;->addPart(Lokhttp3/w;Lokhttp3/l0;)V
