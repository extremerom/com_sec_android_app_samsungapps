...
.field private final headers:Lokhttp3/w;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lokhttp3/x;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lokhttp3/x;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lokhttp3/w;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lokhttp3/w;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lokhttp3/a0;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lokhttp3/a0;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lokhttp3/k0;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lokhttp3/x;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lokhttp3/w;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lokhttp3/a0;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lokhttp3/x;Ljava/lang/String;Lokhttp3/w;Lokhttp3/a0;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lokhttp3/k0$a;
    ...
    invoke-virtual {p1, v1, v0}, Lokhttp3/k0$a;->z(Ljava/lang/Class;Ljava/lang/Object;)Lokhttp3/k0$a;
