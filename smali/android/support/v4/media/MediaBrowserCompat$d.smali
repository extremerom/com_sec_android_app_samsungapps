...
.method public disconnect()V
    ...
    :try_start_0
    invoke-virtual {v0, v1}, Landroid/support/v4/media/MediaBrowserCompat$h;->j(Landroid/os/Messenger;)V
    :try_end_0
...
.method public getItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$c;)V
    .locals 0
...
.method public onConnected()V
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$h;->e(Landroid/content/Context;Landroid/os/Messenger;)V
    :try_end_1
...
.method public search(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$g;)V
    .locals 4
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$d$a;-><init>(Landroid/support/v4/media/MediaBrowserCompat$d;Landroid/support/v4/media/MediaBrowserCompat$g;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p1, p2, p3, v2}, Landroid/support/v4/media/MediaBrowserCompat$SearchResultReceiver;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$g;Landroid/os/Handler;)V
    ...
    invoke-virtual {v2, p1, p2, v0, v3}, Landroid/support/v4/media/MediaBrowserCompat$h;->g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/f;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$d$b;-><init>(Landroid/support/v4/media/MediaBrowserCompat$d;Landroid/support/v4/media/MediaBrowserCompat$g;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$b;)V
    .locals 3
    ...
    invoke-direct {v0, p1, p2, p3, v2}, Landroid/support/v4/media/MediaBrowserCompat$CustomActionResultReceiver;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$b;Landroid/os/Handler;)V

    :try_start_0
    iget-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->g:Landroid/support/v4/media/MediaBrowserCompat$h;

    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->h:Landroid/os/Messenger;

    invoke-virtual {p3, p1, p2, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$h;->h(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/f;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$j;)V
    ...
    check-cast p2, Landroid/support/v4/media/MediaBrowserCompat$i;

    if-nez p2, :cond_0

    new-instance p2, Landroid/support/v4/media/MediaBrowserCompat$i;

    invoke-direct {p2}, Landroid/support/v4/media/MediaBrowserCompat$i;-><init>()V

    iget-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->e:Landroidx/collection/ArrayMap;
...
.method public unsubscribe(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$j;)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat$h;->f(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    invoke-virtual {p2}, Landroid/support/v4/media/MediaBrowserCompat$i;->d()Z
