...
.method public static generateConfigDelta_locale(Landroid/content/res/Configuration;Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0, v0}, Landroidx/appcompat/app/e;->a(Landroid/os/LocaleList;Ljava/lang/Object;)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {p2, v0}, Landroidx/appcompat/app/f;->a(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
...
.method public static setDefaultLocales(Landroidx/core/os/LocaleListCompat;)V
    ...
    invoke-static {p0}, Landroidx/appcompat/app/g;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object p0

    invoke-static {p0}, Landroidx/appcompat/app/h;->a(Landroid/os/LocaleList;)V
...
.method public static setLocales(Landroid/content/res/Configuration;Landroidx/core/os/LocaleListCompat;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/app/g;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object p1

    invoke-static {p0, p1}, Landroidx/appcompat/app/f;->a(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
