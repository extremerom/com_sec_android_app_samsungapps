...
.method public synthetic constructor <init>(Landroidx/core/location/LocationManagerCompat$GnssMeasurementsTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent;)V
    ...
    iput-object p1, p0, Landroidx/core/location/x;->a:Landroidx/core/location/LocationManagerCompat$GnssMeasurementsTransport;

    iput-object p2, p0, Landroidx/core/location/x;->b:Ljava/util/concurrent/Executor;

    iput-object p3, p0, Landroidx/core/location/x;->c:Landroid/location/GnssMeasurementsEvent;
...
.method public final run()V
    ...
    iget-object v0, p0, Landroidx/core/location/x;->a:Landroidx/core/location/LocationManagerCompat$GnssMeasurementsTransport;

    iget-object v1, p0, Landroidx/core/location/x;->b:Ljava/util/concurrent/Executor;

    iget-object v2, p0, Landroidx/core/location/x;->c:Landroid/location/GnssMeasurementsEvent;
