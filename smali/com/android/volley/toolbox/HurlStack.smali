...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/volley/toolbox/HurlStack$a;,
...
.method public static synthetic b(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {p0}, Lcom/android/volley/toolbox/HurlStack;->h(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
...
.method public static d(Ljava/net/HttpURLConnection;Lcom/android/volley/Request;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/android/volley/toolbox/HurlStack;->c(Ljava/net/HttpURLConnection;Lcom/android/volley/Request;[B)V
...
.method public static j(Ljava/net/HttpURLConnection;Lcom/android/volley/Request;)V
    ...
    invoke-static {p0, p1}, Lcom/android/volley/toolbox/HurlStack;->d(Ljava/net/HttpURLConnection;Lcom/android/volley/Request;)V
...
# virtual methods
.method public a(Lcom/android/volley/Request;Ljava/util/Map;)Lcom/android/volley/toolbox/k;
    .locals 5
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/volley/toolbox/HurlStack;->i(Ljava/net/URL;Lcom/android/volley/Request;)Ljava/net/HttpURLConnection;
    ...
    :cond_2
    invoke-static {p2, p1}, Lcom/android/volley/toolbox/HurlStack;->j(Ljava/net/HttpURLConnection;Lcom/android/volley/Request;)V
    ...
    invoke-static {p1, v1}, Lcom/android/volley/toolbox/HurlStack;->g(II)Z
    ...
    invoke-static {v2}, Lcom/android/volley/toolbox/HurlStack;->e(Ljava/util/Map;)Ljava/util/List;

    move-result-object v2

    invoke-direct {p1, v1, v2}, Lcom/android/volley/toolbox/k;-><init>(ILjava/util/List;)V
    :try_end_0
    ...
    new-instance v4, Lcom/android/volley/toolbox/HurlStack$a;

    invoke-direct {v4, p2}, Lcom/android/volley/toolbox/HurlStack$a;-><init>(Ljava/net/HttpURLConnection;)V

    invoke-direct {p1, v1, v2, v3, v4}, Lcom/android/volley/toolbox/k;-><init>(ILjava/util/List;ILjava/io/InputStream;)V
...
.method public final i(Ljava/net/URL;Lcom/android/volley/Request;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {p0, p1}, Lcom/android/volley/toolbox/HurlStack;->f(Ljava/net/URL;)Ljava/net/HttpURLConnection;
