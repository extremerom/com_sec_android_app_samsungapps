...
.method public static final c(Lkotlin/reflect/KType;Z)Ljava/lang/reflect/Type;
    ...
    invoke-direct {p0, v0}, Lkotlin/reflect/r;-><init>(Lkotlin/reflect/KTypeParameter;)V
    ...
    invoke-static {v0}, Lkotlin/jvm/a;->g(Lkotlin/reflect/KClass;)Ljava/lang/Class;
    ...
    :cond_3
    invoke-static {v0}, Lkotlin/collections/o1;->m5(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/p;->a()Lkotlin/reflect/KVariance;

    move-result-object p0

    invoke-virtual {v0}, Lkotlin/reflect/p;->b()Lkotlin/reflect/KType;
...
.method public static final e(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/reflect/Type;
    ...
    invoke-static {v1}, Lkotlin/reflect/TypesJVMKt;->g(Lkotlin/reflect/p;)Ljava/lang/reflect/Type;
...
.method public static final g(Lkotlin/reflect/p;)Ljava/lang/reflect/Type;
    .locals 4

    invoke-virtual {p0}, Lkotlin/reflect/p;->h()Lkotlin/reflect/KVariance;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object p0, Lkotlin/reflect/s;->c:Lkotlin/reflect/s$a;

    invoke-virtual {p0}, Lkotlin/reflect/s$a;->a()Lkotlin/reflect/s;
    ...
    invoke-direct {v0, p0, v1}, Lkotlin/reflect/s;-><init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
    ...
    invoke-direct {v0, v1, p0}, Lkotlin/reflect/s;-><init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
...
.method public static synthetic h(Lkotlin/reflect/KType;)V
    ...
    const-string v0, "Shaking error: Missing method in kotlin.reflect.TypesJVMKt: void getJavaType$annotations(kotlin.reflect.KType)"
...
.method public static synthetic i(Lkotlin/reflect/p;)V
    .locals 1
    ...
    const-string v0, "Shaking error: Missing method in kotlin.reflect.TypesJVMKt: void getJavaType$annotations(kotlin.reflect.KTypeProjection)"
...
.method public static final j(Ljava/lang/reflect/Type;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkotlin/sequences/SequencesKt___SequencesKt;->v1(Lkotlin/sequences/Sequence;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lkotlin/sequences/SequencesKt___SequencesKt;->r0(Lkotlin/sequences/Sequence;)I

    move-result p0

    invoke-static {v1, p0}, Lkotlin/text/l0;->m2(Ljava/lang/CharSequence;I)Ljava/lang/String;
