...
.method public static final synthetic a(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->i(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method private final n(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    const-string p2, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: void loop$atomicfu(java.util.concurrent.atomic.AtomicReferenceFieldUpdater,kotlin.jvm.functions.Function1,java.lang.Object)"
...
.method public final c(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    ...
    const-string v0, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: void addLast(kotlinx.coroutines.internal.LockFreeLinkedListNode)"
...
.method public final d(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlin/jvm/functions/Function0;)Z
    .locals 0
    ...
    const-string p2, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: boolean addLastIf(kotlinx.coroutines.internal.LockFreeLinkedListNode,kotlin.jvm.functions.Function0)"
...
.method public final e(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Z
    ...
    const-string p2, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: boolean addNext(kotlinx.coroutines.internal.LockFreeLinkedListNode,kotlinx.coroutines.internal.LockFreeLinkedListNode)"
...
.method public final f(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Z
    ...
    invoke-virtual {p1, p0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->i(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method public final g(Lkotlinx/coroutines/internal/q0;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .locals 8
    ...
    :cond_4
    instance-of v6, v5, Lkotlinx/coroutines/internal/q0;

    if-eqz v6, :cond_5

    check-cast v5, Lkotlinx/coroutines/internal/q0;

    invoke-virtual {v5, v2}, Lkotlinx/coroutines/internal/q0;->b(Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_5
    instance-of v6, v5, Lkotlinx/coroutines/internal/s0;

    if-eqz v6, :cond_8

    if-eqz v3, :cond_7

    check-cast v5, Lkotlinx/coroutines/internal/s0;

    iget-object v5, v5, Lkotlinx/coroutines/internal/s0;->a:Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final i(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    ...
    invoke-virtual {p1, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->g(Lkotlinx/coroutines/internal/q0;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final k()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-static {v0}, Lkotlinx/coroutines/internal/e0;->f(Ljava/lang/Object;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final l()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-virtual {p0, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->g(Lkotlinx/coroutines/internal/q0;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final o(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlin/jvm/functions/Function0;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode$a;
    .locals 0
    ...
    const-string p2, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: kotlinx.coroutines.internal.LockFreeLinkedListNode$CondAddOp makeCondAddOp(kotlinx.coroutines.internal.LockFreeLinkedListNode,kotlin.jvm.functions.Function0)"
...
.method public p()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .locals 2
    ...
    const-string v1, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: kotlinx.coroutines.internal.LockFreeLinkedListNode nextIfRemoved()"
...
.method public final r()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-virtual {v1}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->s()Lkotlinx/coroutines/internal/s0;
    ...
    invoke-virtual {v1, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->g(Lkotlinx/coroutines/internal/q0;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;

    return-object v0
.end method

.method public final s()Lkotlinx/coroutines/internal/s0;
    .locals 2
    ...
    check-cast v1, Lkotlinx/coroutines/internal/s0;

    if-nez v1, :cond_0

    new-instance v1, Lkotlinx/coroutines/internal/s0;

    invoke-direct {v1, p0}, Lkotlinx/coroutines/internal/s0;-><init>(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method public final t(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode$a;)I
    ...
    :cond_0
    invoke-virtual {p3, p0}, Lkotlinx/coroutines/internal/b;->b(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final u(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    .locals 0
    ...
    const-string p2, "Shaking error: Missing method in kotlinx.coroutines.internal.LockFreeLinkedListNode: void validateNode$kotlinx_coroutines_core(kotlinx.coroutines.internal.LockFreeLinkedListNode,kotlinx.coroutines.internal.LockFreeLinkedListNode)"
