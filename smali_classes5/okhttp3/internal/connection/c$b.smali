...
# direct methods
.method public constructor <init>(Lokhttp3/internal/connection/c;Lokio/Source;J)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/c$b;->f:Lokhttp3/internal/connection/c;

    invoke-direct {p0, p2}, Lokio/r;-><init>(Lokio/Source;)V

    iput-wide p3, p0, Lokhttp3/internal/connection/c$b;->e:J

    const/4 p1, 0x1

    iput-boolean p1, p0, Lokhttp3/internal/connection/c$b;->b:Z
...
.method public final a(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/c$b;->f:Lokhttp3/internal/connection/c;

    invoke-virtual {v0}, Lokhttp3/internal/connection/c;->i()Lokhttp3/EventListener;

    move-result-object v0

    iget-object v1, p0, Lokhttp3/internal/connection/c$b;->f:Lokhttp3/internal/connection/c;
    ...
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/connection/c$b;->f:Lokhttp3/internal/connection/c;

    iget-wide v3, p0, Lokhttp3/internal/connection/c$b;->a:J
...
.method public close()V
    ...
    :try_start_0
    invoke-super {p0}, Lokio/r;->close()V
...
.method public read(Lokio/m;J)J
    ...
    :try_start_0
    invoke-virtual {p0}, Lokio/r;->delegate()Lokio/Source;
    ...
    iget-boolean p3, p0, Lokhttp3/internal/connection/c$b;->b:Z

    if-eqz p3, :cond_0

    const/4 p3, 0x0

    iput-boolean p3, p0, Lokhttp3/internal/connection/c$b;->b:Z

    iget-object p3, p0, Lokhttp3/internal/connection/c$b;->f:Lokhttp3/internal/connection/c;
    ...
    iget-wide v5, p0, Lokhttp3/internal/connection/c$b;->e:J
    ...
    :cond_3
    :goto_1
    iput-wide v3, p0, Lokhttp3/internal/connection/c$b;->a:J
