...
.field public static final f:Lokhttp3/internal/http2/Http2Reader$a;


# instance fields
.field public final a:Lokhttp3/internal/http2/Http2Reader$b;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$a;-><init>(Lkotlin/jvm/internal/t;)V

    sput-object v0, Lokhttp3/internal/http2/Http2Reader;->f:Lokhttp3/internal/http2/Http2Reader$a;
...
.method public constructor <init>(Lokio/BufferedSource;Z)V
    ...
    iput-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lokhttp3/internal/http2/Http2Reader$b;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/b$a;-><init>(Lokio/Source;IIILkotlin/jvm/internal/t;)V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->b:Lokhttp3/internal/http2/b$a;
...
.method public final b(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/d;->R(Lokio/BufferedSource;)I
...
.method public final c(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-static {v2, v3}, Lokhttp3/internal/d;->v(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public final f(IIII)Ljava/util/List;
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lokhttp3/internal/http2/Http2Reader$b;

    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Http2Reader$b;->h(I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lokhttp3/internal/http2/Http2Reader$b;
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->b:Lokhttp3/internal/http2/b$a;
...
.method public final m(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    new-instance p3, Lokhttp3/internal/http2/i;

    invoke-direct {p3}, Lokhttp3/internal/http2/i;-><init>()V

    const/4 v0, 0x0

    invoke-static {v0, p2}, Lkotlin/ranges/v;->W1(II)Lkotlin/ranges/m;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkotlin/ranges/v;->B1(Lkotlin/ranges/k;I)Lkotlin/ranges/k;
    ...
    invoke-virtual {p2}, Lkotlin/ranges/k;->c()I
    ...
    :cond_a
    :goto_1
    invoke-virtual {p3, v3, v4}, Lokhttp3/internal/http2/i;->k(II)Lokhttp3/internal/http2/i;
    ...
    :cond_b
    invoke-interface {p1, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->settings(ZLokhttp3/internal/http2/i;)V
