...
.field public static final j:Lokhttp3/internal/concurrent/TaskRunner$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/concurrent/TaskRunner$a;-><init>(Lkotlin/jvm/internal/t;)V

    sput-object v0, Lokhttp3/internal/concurrent/TaskRunner;->j:Lokhttp3/internal/concurrent/TaskRunner$a;
    ...
    sget-object v3, Lokhttp3/internal/d;->i:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lokhttp3/internal/d;->U(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
...
.method public static final synthetic b(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/internal/concurrent/a;)V
    .locals 0

    invoke-virtual {p0, p1}, Lokhttp3/internal/concurrent/TaskRunner;->k(Lokhttp3/internal/concurrent/a;)V
...
.method public final c()Ljava/util/List;
    ...
    const-string v1, "Shaking error: Missing method in okhttp3.internal.concurrent.TaskRunner: java.util.List activeQueues()"
...
.method public final d(Lokhttp3/internal/concurrent/a;J)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Lokhttp3/internal/concurrent/a;->d()Lokhttp3/internal/concurrent/f;

    move-result-object v0

    invoke-static {v0}, Lkotlin/jvm/internal/f0;->m(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lokhttp3/internal/concurrent/f;->e()Lokhttp3/internal/concurrent/a;
    ...
    invoke-virtual {v0}, Lokhttp3/internal/concurrent/f;->f()Z

    move-result v1

    invoke-virtual {v0, v2}, Lokhttp3/internal/concurrent/f;->s(Z)V

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lokhttp3/internal/concurrent/f;->r(Lokhttp3/internal/concurrent/a;)V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/concurrent/f;->j()Z

    move-result v1

    if-nez v1, :cond_3

    invoke-virtual {v0, p1, p2, p3, v3}, Lokhttp3/internal/concurrent/f;->q(Lokhttp3/internal/concurrent/a;JZ)Z

    :cond_3
    invoke-virtual {v0}, Lokhttp3/internal/concurrent/f;->g()Ljava/util/List;
...
.method public final e()Lokhttp3/internal/concurrent/a;
    ...
    check-cast v7, Lokhttp3/internal/concurrent/f;

    invoke-virtual {v7}, Lokhttp3/internal/concurrent/f;->g()Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Lokhttp3/internal/concurrent/TaskRunner;->f(Lokhttp3/internal/concurrent/a;)V
...
.method public final f(Lokhttp3/internal/concurrent/a;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/concurrent/f;->r(Lokhttp3/internal/concurrent/a;)V
...
.method public final g()V
    ...
    check-cast v1, Lokhttp3/internal/concurrent/f;

    invoke-virtual {v1}, Lokhttp3/internal/concurrent/f;->b()Z
    ...
    invoke-virtual {v1}, Lokhttp3/internal/concurrent/f;->g()Ljava/util/List;
...
.method public final i(Lokhttp3/internal/concurrent/f;)V
    .locals 3
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Lokhttp3/internal/concurrent/f;->e()Lokhttp3/internal/concurrent/a;

    move-result-object v0

    if-nez v0, :cond_3

    invoke-virtual {p1}, Lokhttp3/internal/concurrent/f;->g()Ljava/util/List;
    ...
    invoke-static {v0, p1}, Lokhttp3/internal/d;->a(Ljava/util/List;Ljava/lang/Object;)V
...
.method public final j()Lokhttp3/internal/concurrent/f;
    .locals 4
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/concurrent/f;-><init>(Lokhttp3/internal/concurrent/TaskRunner;Ljava/lang/String;)V
...
.method public final k(Lokhttp3/internal/concurrent/a;)V
    .locals 5
    ...
    :try_start_1
    invoke-virtual {p0, p1, v2, v3}, Lokhttp3/internal/concurrent/TaskRunner;->d(Lokhttp3/internal/concurrent/a;J)V
    ...
    :try_start_2
    invoke-virtual {p0, p1, v3, v4}, Lokhttp3/internal/concurrent/TaskRunner;->d(Lokhttp3/internal/concurrent/a;J)V
